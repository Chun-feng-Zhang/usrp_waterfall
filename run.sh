...
sudo taskset -c 3,4,5,6 nice -20 ./build/rt_cpubackend --rate 40e6 --freq 100e6 --nch 2048 --batch 512 --wirefmt sc8 --gain 1 --args 'name=MyB210' --bw 40e6 --nbatch 32 --setup 2 --filfile ./test.fil --sourcename testsource
