    ...
    )
{
    ...
    handler_f=[&](const DataFrame& df){
        ...
        std::cerr<<"dump fft result to "<< freq_domain_dump_name <<std::endl;
...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    std::string tdump, fftfile, specfile;
    ...
    desc.add_options()
        ...
        ("fftfile", po::value<std::string>(&fftfile)->default_value(""), "dump FFT to file")
